        ...
        <div class="container">
            <div class="row mt-5">
                <div class="col-md-10 offset-md-1">
                    <form method="post" action="{{ route('backend.doUpload') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <h3 class="text-center">Upload Photo Here</h3>

                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <a href="{{ route('backend.home') }}" class="btn btn-primary w-150">
                                Upload a File
                            </a>
                            <a href="{{ route('backend.url') }}" class="btn btn-outline-primary w-150">
                                By URL
                            </a>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            <label for="js-file">File</label>
                            <input type="file" class="form-control" id="js-file" name="file" placeholder="Choose file...">
                        </div>                        
